...
public class RobotContainer {
  ...
  private final AprilTagLock mAprilTagLock2;
  ...
  public RobotContainer() {
    ...
    // lock = new Auto(mSwerveSubsystem, mLimelight, Constants.AprilTags.rightCoral[0], Constants.AprilTags.leftCoral[1], Constants.AprilTags.leftCoral[2]);
    ...
    mAprilTagLock2 = new AprilTagLock(mSwerveSubsystem, mLimelight, Constants.AprilTags.rightCoral[0], Constants.AprilTags.rightCoral[1], Constants.AprilTags.rightCoral[2]);
